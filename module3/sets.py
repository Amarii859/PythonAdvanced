...
print("union of set1 and set2 method:", union_result_operator)
...
print("intersection of set1 and set2 method :" , intersection_result_operator)
...
symmetric_result_method = set1.intersection(set2)
symmetric_result_operator = set1 & set2

print("symmetric of set1 and set2 method :" , symmetric_result_method)
print("symmetric of set1 and set2 method :" , symmetric_result_operator)
...
common_interests = user1_intersection.intesection(user2_intersection)
